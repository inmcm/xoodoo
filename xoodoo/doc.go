...
// other cryptographic primitives and modes can be build. Xoodoo operates on a 384-bit state, realized
// here as array of twelve(12) 32-bit unsigned integers, to generate a new pseudo-random state each time
